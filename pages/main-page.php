<div class="main-panel" style="padding-top: 0px;">
    <div class="content-wrapper" style="padding-top: 20px;padding-bottom: 20px;padding-right: 20px;padding-left: 20px;">
        <div class="row">
                        ...
                        <form class="forms-sample" id="formSearch">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-inline">
                                    ...
                                    <input id="n0" name="n0" type="text" style="width: 30px; color: white; text-align: center; background-color: #2A3038;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;" disabled value="0" maxlength="1" class="form-control">&nbsp;
                                    <input id="n1" name="n1" value="<?= $_GET['n1'] ?>" onkeyup="dofucus(2,this)" type="text" style="background-color: #2A3038; width: 30px; color: white; text-align: center;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;" maxlength="1" class="form-control">&nbsp;
                                    <input id="n2" name="n2" value="<?= $_GET['n2'] ?>" onkeyup="dofucus(3,this)" type="text" style=" background-color: #2A3038; width: 30px; color: white; text-align: center;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;" maxlength="1" class="form-control"> -
                                    <input id="n3" name="n3" value="<?= $_GET['n3'] ?>" onkeyup="dofucus(4,this)" type="text" style="background-color: #2A3038; width: 30px; color: white; text-align: center;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;" maxlength="1" class="form-control">&nbsp;
                                    <input id="n4" name="n4" value="<?= $_GET['n4'] ?>" type="text" onkeyup="dofucus(5,this)" style="background-color: #2A3038; width: 30px; color: white; text-align: center;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;" maxlength="1" class="form-control">&nbsp;
                                    <input id="n5" name="n5" value="<?= $_GET['n5'] ?>" type="text" onkeyup="dofucus(6,this)" style="background-color: #2A3038; width: 30px; color: white; text-align: center;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;" maxlength="1" class="form-control">&nbsp;
                                    <input id="n6" name="n6" value="<?= $_GET['n6'] ?>" type="text" onkeyup="dofucus(7,this)" style="background-color: #2A3038; width: 30px; color: white; text-align: center;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;" maxlength="1" class="form-control">&nbsp;
                                    <input id="n7" name="n7" value="<?= $_GET['n7'] ?>" type="text" onkeyup="dofucus(8,this)" style="background-color: #2A3038; width: 30px; color: white; text-align: center;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;" maxlength="1" class="form-control">&nbsp;
                                    <input id="n8" name="n8" value="<?= $_GET['n8'] ?>" type="text" onkeyup="dofucus(9,this)" style="background-color: #2A3038; width: 30px; color: white; text-align: center;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;" maxlength="1" class="form-control">&nbsp;
                                    <input id="n9" name="n9" value="<?= $_GET['n9'] ?>" type="text" onkeyup="dofucus(9,this)" style="width: 30px; color: white; text-align: center;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;" maxlength="1" class="form-control">
                                </div>
